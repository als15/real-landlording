...
const ACTION_MESSAGES: Record<string, string> = {
  booked: "Great news! We've noted that the job is booked. We'll check back when it's time for a completion update.",
  ...
  completed: "Congratulations on completing the project! We'll send the landlord a feedback request.",
  in_progress: "Thanks for the update! We'll check back in about a week.",
  cancelled: "We've noted the cancellation. Thanks for keeping us informed.",
};
